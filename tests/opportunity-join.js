...
describe('Authenticated Users', function() {
  ...
  describe('joining', function() {
    ...
    it ('allows user to join public opportunity', function(done){
      var oppId;
      var oppToJoin;
      var newToken;
      async.waterfall([
    ...
    it ('prevents user from join public opportunity twice', function(done){
      var oppId;
      var oppToJoin;
      var newToken;
      async.waterfall([
    ...
    it ('allow user to join a private opportunity if they have been invited', function(done){
      var oppId;
      var oppToJoin;
      var newToken;
      var userToInvite;
