...
describe('Anonymous Users', function() {
  ...
  describe('leaving', function() {
    it ('should prevent anonymous users from accessing', function(done){
      request
     	.post('/opportunities/remove-member')
     	.send()
          ...
          function (callback) {
            ...
            request
             ...
             .end(function(err, res) {
               ...
               expect(res.body.message).to.equal('You removed a member from the opp')
               callback()
             });
          },
      ], done)
          ...
          function (callback) {
            ...
            request
             ...
             .end(function(err, res) {
               ...
               expect(res.body.message).to.equal('You do not have access to remove the opp')
               callback()
             });
          },
      ], done)
